...
<html lang="en">
	...
	<head><base href="../../../"/>
		...
		<meta property="og:site_name" content="Furnimart | Furnimart" />
		<link rel="shortcut icon" href="assets/media/logos/furnimart.png" />
			...
			<div class="d-flex flex-column flex-lg-row flex-column-fluid">
				...
				<div class="d-flex flex-lg-row-fluid">
					...
					<div class="d-flex flex-column flex-center pb-0 pb-lg-10 p-10 w-100">
						<!--begin::Image-->
						<img class="theme-light-show mx-auto mw-100 w-150px w-lg-300px mb-10 mb-lg-20" src="assets/media/auth/Forgot-password.png" alt="" />
						<img class="theme-dark-show mx-auto mw-100 w-150px w-lg-300px mb-10 mb-lg-20" src="assets/media/auth/Forgot-password.png" alt="" />
						<!--end::Image-->
						<!--begin::Title-->
						<h1 class="text-gray-800 fs-2qx fw-bold text-center mb-7">Forgot Password  ?</h1>
						<!--end::Title-->
						<!--begin::Text-->
